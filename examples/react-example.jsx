  ...
  return (
    <div className="consent-manager">
      ...
      <div className="consent-status">
        ...
        {consent ? <pre>{JSON.stringify(consent, null, 2)}</pre> : <p>No consent data found</p>}
      </div>
...
const App = () => {
  return (
    <div className="app">
      ...
      <main>
        <p>
          This example demonstrates how to integrate the Accessible Cookie Banner in a React
          application. The banner is initialized in a React component and the consent state is
