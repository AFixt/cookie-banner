...
describe('Cookie Blocker', () => {
  ...
  describe('Script Blocking', () => {
    ...
    test('should block inline scripts with tracking code', () => {
      ...
      expect(script.parentNode).toBeNull();
      expect(console.log).toHaveBeenCalledWith('Blocked inline tracking script containing:', 'ga(');
    });
  ...
  describe('Cookie Blocking', () => {
    ...
    test('should block analytics cookies', () => {
      ...
      expect(console.log).toHaveBeenCalledWith('Blocked cookie:', '_ga=GA1.2.123456789.1234567890');
    });
    ...
    test('should block marketing cookies', () => {
      ...
      expect(console.log).toHaveBeenCalledWith('Blocked cookie:', '_fbp=fb.1.1234567890.123456789');
    });
