    ...
    await page.evaluate(() => {
      ...
      if (description) {
        description.textContent =
          'We use cookies and similar technologies to enhance your browsing experience, analyze site traffic, personalize content and advertisements, and provide social media features. By continuing to use our website, you consent to our use of cookies. Please review our privacy policy for more information about how we collect, use, and protect your data.';
      }
    });
